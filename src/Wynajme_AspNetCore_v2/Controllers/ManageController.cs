...
using Wynajme_AspNetCore_v2.Models.ManageViewModels;
...
namespace Wynajme_AspNetCore_v2.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        // POST: /Manage/Ustawienia
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Ustawienia(UstawieniaViewModel model, IFormFile image)
        {
